...
public class CmdDebug extends FCommand {
    ...
    public void perform(CommandContext context) {
        ...
        Logger.print("Rally: " + FCmdRoot.instance.rallyEnabled, Logger.PrefixType.DEBUG);
        Logger.print("F Strikes: " + FCmdRoot.instance.fStrikesEnabled, Logger.PrefixType.DEBUG);
        Logger.print("F Reserve: " + FCmdRoot.instance.reserveEnabled, Logger.PrefixType.DEBUG);
        Logger.print("Inventory See: " + FCmdRoot.instance.invSeeEnabled, Logger.PrefixType.DEBUG);
        Logger.print("Money: " + FCmdRoot.instance.moneyEnabled, Logger.PrefixType.DEBUG);
        Logger.print("See Chunks: " + FCmdRoot.instance.seeChunkEnabled, Logger.PrefixType.DEBUG);
        Logger.print("Drain : " + FCmdRoot.instance.factionDrainEnabled, Logger.PrefixType.DEBUG);
        Logger.print("Friendly Fire " + FCmdRoot.instance.friendlyFireEnabled, Logger.PrefixType.DEBUG);
        Logger.print("Fly: " + FCmdRoot.instance.fFlyEnabled, Logger.PrefixType.DEBUG);
        Logger.print("F Warp: " + FCmdRoot.instance.warpsEnabled, Logger.PrefixType.DEBUG);
