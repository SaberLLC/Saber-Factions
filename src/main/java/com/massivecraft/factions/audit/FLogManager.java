...
public class FLogManager {
    ...
    private void scheduleLogMaintenance() {
        // Replace scheduleSyncRepeatingTask with runAtFixedRate
        Bukkit.getGlobalRegionScheduler().runAtFixedRate(
            ...
            scheduledTask -> {
                ...
                logTimers.entrySet().removeIf(entry -> {
                    ...
                    if (logTimer == null
                            || logTimer.getFactionId() == null
                            || Factions.getInstance().getFactionById(logTimer.getFactionId()) == null) {
                        Bukkit.getLogger().info("Null faction for logs " + (logTimer != null ? logTimer.getFactionId() : "null logTimer"));
                        return true;
                    }
