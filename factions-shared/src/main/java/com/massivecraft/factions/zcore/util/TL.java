...
public enum TL {
    ...
    COMMAND_ADMINFACTION_DESCRIPTION("Manage server-managed admin factions"),
    ...
    COMMAND_CREATEADMIN_SUCCESS("&c&l[!] &7Created admin faction &c%1$s&7. It is permanent and can only be disbanded by an admin."),
    COMMAND_CREATEADMIN_DESCRIPTION("Create a permanent admin faction"),
    ...
    COMMAND_JOIN_ADMINFACTION("&c&l[!] &7This is a server-managed admin faction. Players cannot join it."),
    ...
    COMMAND_ROLE_DESCRIPTION("Manage faction roles."),
    COMMAND_ROLE_USAGE("&e/f role&7, &e/f role gui&7, &e/f role list&7, &e/f role create <id> <baseRole>&7, &e/f role set <player> <role>&7, &e/f role default <role>&7, &e/f role delete <role>"),
    COMMAND_ROLE_LIST_HEADER("&eFaction roles for &f%s&e:"),
    COMMAND_ROLE_LIST_ENTRY("&e- &f%s &7[id: &f%s&7, tier: &f%s&7%s&7]"),
    COMMAND_ROLE_LIST_DEFAULT_FLAG("&edefault"),
    COMMAND_ROLE_LIMIT_REACHED("&c&l[!] &7You have reached the custom role limit of &c%s&7."),
    COMMAND_ROLE_INVALID_ID("&c&l[!] &7That role id is invalid. Use letters, numbers, underscores, or hyphens."),
    COMMAND_ROLE_RESERVED_ID("&c&l[!] &7That role id is reserved."),
    COMMAND_ROLE_ALREADY_EXISTS("&c&l[!] &7A role with id &c%s &7already exists."),
    COMMAND_ROLE_UNKNOWN_BASE("&c&l[!] &7Unknown base role &c%s&7."),
    COMMAND_ROLE_LEADER_TIER_FORBIDDEN("&c&l[!] &7Custom roles cannot use the leader tier."),
    COMMAND_ROLE_CREATE_FAILED("&c&l[!] &7Unable to create that role."),
    COMMAND_ROLE_CREATED("&a&l[!] &7Created role &a%s &7from &a%s&7."),
    COMMAND_ROLE_NOT_IN_FACTION("&c&l[!] &7That player is not in your faction."),
    COMMAND_ROLE_ALT_ASSIGN_DENIED("&c&l[!] &7Alt members cannot be assigned faction roles."),
    COMMAND_ROLE_UNKNOWN("&c&l[!] &7Unknown role &c%s&7."),
    COMMAND_ROLE_USE_ADMIN_TRANSFER("&c&l[!] &7Use &f/f admin <player> &7to transfer leadership."),
    COMMAND_ROLE_USE_ADMIN_CURRENT_LEADER("&c&l[!] &7Use &f/f admin <player> &7to change the current leader."),
    COMMAND_ROLE_ASSIGNED("&a&l[!] &7Assigned &e%s &7to &a%s&7."),
    COMMAND_ROLE_ASSIGNED_TARGET("&a&l[!] &7Your faction role was set to &e%s&7."),
    COMMAND_ROLE_SYSTEM_DELETE_DENIED("&c&l[!] &7Default roles cannot be deleted."),
    COMMAND_ROLE_DELETE_FAILED("&c&l[!] &7Unable to delete role &c%s&7."),
    COMMAND_ROLE_DELETED("&a&l[!] &7Deleted role &a%s&7."),
    COMMAND_ROLE_LEADER_DEFAULT_DENIED("&c&l[!] &7Leader cannot be the default join role."),
    COMMAND_ROLE_DEFAULT_SET("&a&l[!] &7Set the default faction role to &a%s&7."),
    COMMAND_ROLE_CUSTOM_DISABLED("&c&l[!] &7Custom faction roles are disabled."),
    COMMAND_ROLE_CUSTOM_DISABLED_HELP("&7Use &f/f promote <player>&7, &f/f demote <player>&7, &f/f mod <player>&7, &f/f coleader <player>&7, &f/f admin <player>&7, and &f/f defaultrole <role>&7."),
    COMMAND_ROLE_GUI_INPUT_MODE("&eType the new value in chat.\n&7Type &ccancel &7to return to the menu."),
    COMMAND_ROLE_GUI_PROMPT_DISPLAY_NAME("&eRename &f{role-name}&e.\n&7Example: &fVeteran\n&7Type &fclear &7to reset it."),
    COMMAND_ROLE_GUI_PROMPT_CREATE_ROLE("&eEnter a name for the new role.\n&7Template: &f{role-name}"),
    COMMAND_ROLE_GUI_INPUT_CANCELLED("&cRole input cancelled."),
    COMMAND_ROLE_GUI_ROLE_MISSING("&cThat role no longer exists."),
    COMMAND_ROLE_GUI_MEMBER_MISSING("&cThat faction member is no longer available."),
    COMMAND_ROLE_GUI_ROLE_LIMIT_REACHED("&cYou have reached the custom role limit of &f{role-limit}&c."),
    COMMAND_ROLE_GUI_INVALID_ROLE_ID("&cThat role name is invalid."),
    COMMAND_ROLE_GUI_RESERVED_ROLE_ID("&cThat name matches a built-in role and can't be used."),
    COMMAND_ROLE_GUI_ROLE_EXISTS("&cA role named &f{role-id} &calready exists."),
    COMMAND_ROLE_GUI_LEADER_TIER_FORBIDDEN("&cCustom roles cannot use the leader role."),
    COMMAND_ROLE_GUI_ROLE_CREATE_FAILED("&cUnable to create that role."),
    COMMAND_ROLE_GUI_ROLE_CREATED("&aCreated role &f{role-name} &afrom &f{base-role-name}&a."),
    COMMAND_ROLE_GUI_LEADER_DEFAULT("&cLeader cannot be the default join role."),
    COMMAND_ROLE_GUI_DEFAULT_SET("&aDefault faction role set to &f{role-name}&a."),
    COMMAND_ROLE_GUI_DISPLAY_NAME_RESET("&aRole name reset to &f{role-name}&a."),
    COMMAND_ROLE_GUI_DISPLAY_NAME_UPDATED("&aRole name set to &f{role-name}&a."),
    COMMAND_ROLE_GUI_ROLE_DELETED("&aDeleted role &f{role-name}&a."),
    COMMAND_ROLE_GUI_ROLE_DELETE_FAILED("&cUnable to delete role &f{role-name}&c."),
    COMMAND_ROLE_GUI_USE_ADMIN_TRANSFER("&cUse /f admin <player> to transfer leadership."),
    COMMAND_ROLE_GUI_MEMBER_ROLE_UNCHANGED("&e{member-name} &7already has that role."),
    COMMAND_ROLE_GUI_MEMBER_ROLE_SET("&aAssigned &f{role-name} &ato &f{member-name}&a."),
