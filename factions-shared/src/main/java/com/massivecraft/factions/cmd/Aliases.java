...
public class Aliases {
    ...
    public static ArrayList<String> adminFaction = new ArrayList<>(Arrays.asList("adminfaction", "afaction", "adminfac"));
    ...
    public static ArrayList<String> createAdmin = new ArrayList<>(Arrays.asList("createadmin", "admincreate"));
